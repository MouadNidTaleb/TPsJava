...
//On peux pas trier les valeurs car on utiliser la méthode hashcode par défaut de la classes

//		Set<Client> set2 = new TreeSet<Client>();
...
//		Comparator<Client> c = (Comparator<Client>) new CodeComparator();
